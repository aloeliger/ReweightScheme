...
def CalculateTriggerWeight2016(self,theTree):
    ...
    if theTree.Trigger22:                
        ...
        self.value[0] = self.TriggerSFFile.w.function("t_trg_pog_deeptau_medium_mutau_ratio").getVal() * self.TriggerSFFile.w.function("m_trg_19_ic_ratio").getVal()
...
def CalculateTriggerWeight2016_Trigger22_DOWN(self,theTree,uncert):
    ...
    if theTree.Trigger22:        
        ...
        self.uncertaintyVariationArrays[uncert][0] = self.TriggerSFFile.w.function("t_trg_pog_deeptau_medium_mutau_ratio").getVal() * self.TriggerSFFile.w.function("m_trg_19_ic_ratio").getVal()
...
def CalculateTriggerWeight2016_Trigger1920_UP(self,theTree,uncert):
    ...
    if theTree.Trigger22:        
        ...
        self.value[0] = self.TriggerSFFile.w.function("t_trg_pog_deeptau_medium_mutau_ratio_up").getVal() * self.TriggerSFFile.w.function("m_trg_19_ic_ratio").getVal() * 1.02
...
def CalculateTriggerWeight2016_Trigger1920_DOWN(self,theTree,uncert):
    ...
    if theTree.Trigger22:        
        ...
        self.uncertaintyVariationArrays[uncert][0] = self.TriggerSFFile.w.function("t_trg_pog_deeptau_medium_mutau_ratio_down").getVal() * self.TriggerSFFile.w.function("m_trg_19_ic_ratio").getVal() * 0.98
