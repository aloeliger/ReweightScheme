...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_Deep/WW.root"
crossSectionWeight.sample = 'WW'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_Deep/WW.root")
