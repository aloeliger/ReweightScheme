...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_Deep/WplusHWW.root"
crossSectionWeight.sample = 'WplusHWW'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_Deep/WplusHWW.root")
