...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_Deep/TTToHadronic.root"
crossSectionWeight.sample = 'TTToHadronic'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_Deep/TTToHadronic.root")
