...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_Deep/ST_t_antitop.root"
crossSectionWeight.sample = 'ST_t_antitop'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_Deep/ST_t_antitop.root")
