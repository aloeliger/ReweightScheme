...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_Deep/GGZHNNTT.root"
crossSectionWeight.sample = 'GGZHNNTT'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_Deep/GGZHNNTT.root")
