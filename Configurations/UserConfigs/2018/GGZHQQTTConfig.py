...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_Deep/GGZHQQTT.root"
crossSectionWeight.sample = 'GGZHQQTT'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_Deep/GGZHQQTT.root")
