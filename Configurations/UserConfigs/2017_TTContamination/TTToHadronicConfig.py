...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_TTContamination/TTToHadronic.root"
crossSectionWeight.sample = 'TTToHadronic'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_TTContamination/TTToHadronic.root")
