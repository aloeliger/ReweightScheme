...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/EWKZLL.root"
crossSectionWeight.sample = 'EWKZLL'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/EWKZLL.root")
