...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/WminusHWW.root"
crossSectionWeight.sample = 'WminusHWW'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/WminusHWW.root")
