...
from Configurations.Weights.QCDAcceptanceWeights.VH_QCD_Acceptance import ZHStyleWeight_2016
...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/ZH.root"
crossSectionWeight.sample = 'ZH'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/ZH.root")
