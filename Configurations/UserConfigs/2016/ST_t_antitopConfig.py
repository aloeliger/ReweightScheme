...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/ST_t_antitop.root"
crossSectionWeight.sample = 'ST_t_antitop'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/ST_t_antitop.root")
