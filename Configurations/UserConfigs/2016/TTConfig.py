...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/TT.root"
crossSectionWeight.sample = 'TT'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/TT.root")
