...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/ST_tW_top.root"
crossSectionWeight.sample = 'ST_tW_top'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/ST_tW_top.root")
