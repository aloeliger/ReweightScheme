...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/WZ3L1Nu.root"
crossSectionWeight.sample = 'WZ3L1Nu'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/WZ3L1Nu.root")
