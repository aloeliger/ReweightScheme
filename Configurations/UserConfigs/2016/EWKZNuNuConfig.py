...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/EWKZNuNu.root"
crossSectionWeight.sample = 'EWKZNuNu'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/EWKZNuNu.root")
