...
from Configurations.Weights.QCDAcceptanceWeights.ggVH_QCD_Acceptance import ggZHLLTTStyleWeight_2016

from Configurations.ConfigDefinition import ReweightConfiguration

EWKConfiguration = ReweightConfiguration()
EWKConfiguration.name = "GGZHLLTT"
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_Deep/GGZHLLTT.root"
crossSectionWeight.sample = 'GGZHLLTT'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_Deep/GGZHLLTT.root")
