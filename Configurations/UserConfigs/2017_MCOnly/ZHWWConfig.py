...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_MCOnly_Deep/ZHWW.root"
crossSectionWeight.sample = 'ZHWW'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_MCOnly_Deep/ZHWW.root")
