...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_MCOnly_Deep/WHMinus.root"
crossSectionWeight.sample = 'WHMinus'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_MCOnly_Deep/WHMinus.root")
