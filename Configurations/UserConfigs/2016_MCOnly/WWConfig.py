...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_MCOnly_Deep/WW.root"
crossSectionWeight.sample = 'WW'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_MCOnly_Deep/WW.root")
