...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_AntiIso_Deep/TTTo2L2Nu.root"
crossSectionWeight.sample = 'TTTo2L2Nu'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_AntiIso_Deep/TTTo2L2Nu.root")
