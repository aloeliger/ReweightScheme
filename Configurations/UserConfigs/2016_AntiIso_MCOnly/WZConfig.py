...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_MCOnly_AntiIso_Deep/WZ.root"
crossSectionWeight.sample = 'WZ'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_MCOnly_AntiIso_Deep/WZ.root")
