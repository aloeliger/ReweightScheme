...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_MCOnly_AntiIso_Deep/VBF.root"
crossSectionWeight.sample = 'VBF'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_MCOnly_AntiIso_Deep/VBF.root")
