...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_MCOnly_AntiIso_Deep/ST_t_top.root"
crossSectionWeight.sample = 'ST_t_top'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_MCOnly_AntiIso_Deep/ST_t_top.root")
