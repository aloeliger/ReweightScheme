...
from Configurations.Weights.QCDAcceptanceWeights.ggVH_QCD_Acceptance import ggZHQQTTStyleWeight_2017
...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHQQTT.root"
crossSectionWeight.sample = 'GGZHQQTT'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHQQTT.root")
