...
from Configurations.Weights.QCDAcceptanceWeights.VH_QCD_Acceptance import WminusHStyleWeight_2017
...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/WHMinus.root"
crossSectionWeight.sample = 'WHMinus'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/WHMinus.root")
