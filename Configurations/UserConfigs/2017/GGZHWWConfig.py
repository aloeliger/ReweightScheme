...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHWW.root"
crossSectionWeight.sample = 'GGZHWW'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHWW.root")
