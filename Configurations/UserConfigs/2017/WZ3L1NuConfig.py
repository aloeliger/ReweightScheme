...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/WZ3L1Nu.root"
crossSectionWeight.sample = 'WZ3L1Nu'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/WZ3L1Nu.root")
