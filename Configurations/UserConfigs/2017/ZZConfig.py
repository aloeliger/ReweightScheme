...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/ZZ.root"
crossSectionWeight.sample = 'ZZ'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/ZZ.root")
