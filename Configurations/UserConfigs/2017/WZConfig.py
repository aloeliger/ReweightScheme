...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/WZ.root"
crossSectionWeight.sample = 'WZ'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/WZ.root")
