...
from Configurations.Weights.QCDAcceptanceWeights.ggVH_QCD_Acceptance import ggZHLLTTStyleWeight_2017
...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHLLTT.root"
crossSectionWeight.sample = 'GGZHLLTT'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHLLTT.root")
