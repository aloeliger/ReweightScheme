...
from Configurations.Weights.QCDAcceptanceWeights.VH_QCD_Acceptance import WplusHStyleWeight_2017
...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/WHPlus.root"
crossSectionWeight.sample = 'WHPlus'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/WHPlus.root")
