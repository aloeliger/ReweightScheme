...
from Configurations.Weights.QCDAcceptanceWeights.ggVH_QCD_Acceptance import ggZHNNTTStyleWeight_2017

from Configurations.ConfigDefinition import ReweightConfiguration

EWKConfiguration = ReweightConfiguration()
EWKConfiguration.name = "GGZHNNTT"
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHNNTT.root"
crossSectionWeight.sample = 'GGZHNNTT'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/GGZHNNTT.root")
