...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/TTToSemiLeptonic.root"
crossSectionWeight.sample = 'TTToSemiLeptonic'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/TTToSemiLeptonic.root")
