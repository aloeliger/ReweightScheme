...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/EWKZLL.root"
crossSectionWeight.sample = 'EWKZLL'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/EWKZLL.root")
