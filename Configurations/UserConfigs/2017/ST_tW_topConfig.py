...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_Deep/ST_tW_top.root"
crossSectionWeight.sample = 'ST_tW_top'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_Deep/ST_tW_top.root")
