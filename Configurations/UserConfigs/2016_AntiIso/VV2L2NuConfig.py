...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_AntiIso_Deep/VV2L2Nu.root"
crossSectionWeight.sample = 'VV2L2Nu'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_AntiIso_Deep/VV2L2Nu.root")
