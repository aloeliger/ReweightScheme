...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2016_AntiIso_Deep/ST_tW_antitop.root"
crossSectionWeight.sample = 'ST_tW_antitop'
crossSectionWeight.year = '2016'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2016_AntiIso_Deep/ST_tW_antitop.root")
