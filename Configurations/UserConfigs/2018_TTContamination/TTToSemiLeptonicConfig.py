...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_TTContamination/TTToSemiLeptonic.root"
crossSectionWeight.sample = 'TTToSemiLeptonic'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_TTContamination/TTToSemiLeptonic.root")
