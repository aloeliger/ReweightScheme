...
EWKConfiguration.name = "ZZ2L2Q"
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_MCOnly_AntiIso_Deep/ZZ2L2Q.root"
crossSectionWeight.sample = 'ZZ2L2Q'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_MCOnly_AntiIso_Deep/ZZ2L2Q.root")
