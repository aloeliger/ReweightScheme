...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2018_MCOnly_AntiIso_Deep/WHPlus.root"
crossSectionWeight.sample = 'WHPlus'
crossSectionWeight.year = '2018'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2018_MCOnly_AntiIso_Deep/WHPlus.root")
