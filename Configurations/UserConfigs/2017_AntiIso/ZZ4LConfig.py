...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_AntiIso_Deep/ZZ4L.root"
crossSectionWeight.sample = 'ZZ4L'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_AntiIso_Deep/ZZ4L.root")
