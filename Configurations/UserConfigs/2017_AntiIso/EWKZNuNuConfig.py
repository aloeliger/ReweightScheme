...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_AntiIso_Deep/EWKZNuNu.root"
crossSectionWeight.sample = 'EWKZNuNu'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_AntiIso_Deep/EWKZNuNu.root")
