...
EWKConfiguration.inputFile = "/data/aloeliger/SMHTT_Selected_2017_AntiIso_Deep/GGHWW.root"
crossSectionWeight.sample = 'GGHWW'
crossSectionWeight.year = '2017'
totalEventsFile = ROOT.TFile.Open("/data/aloeliger/SMHTT_Selected_2017_AntiIso_Deep/GGHWW.root")
